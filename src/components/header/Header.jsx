...
//         color:"black"
//       }}>
//                     <Link to="/myaccount" style={{textDecoration:"none",color:"black", display:'flex', alignItems:'center', gap:'10px', padding:'0px 0px 0px 20px'}}> <img src={nameIcon} alt="" width="20px" /> My account</Link>
//                     <hr />
//                     <Link to="/wishlist" style={{textDecoration:"none",color:"black", display:'flex', alignItems:'center', gap:'10px', padding:'0px 0px 0px 20px'}}> <img src={heartIcon} alt="" width="20px"/> Wishlist</Link>
//                     <Link to="/myorder" style={{textDecoration:"none",color:"black", display:'flex', alignItems:'center', gap:'10px', padding:'0px 0px 0px 20px'}}> <img src={checkout} alt="" width="20px"/> My Orders</Link>
//                     <Link to="/" style={{textDecoration:"none",color:"black", display:'flex', alignItems:'center', gap:'10px', padding:'0px 0px 0px 20px'}}> <img src={logout} alt="" width="20px"/> Log out</Link>
//                     </div>
//                 )}
//                 </div>
//                 </div>   
